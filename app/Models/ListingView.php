...
{
    //
    public static function createViewLog($listing) {
        $listingViews= new ListingView();
        $listingViews->listings_id = $listing->id;
        ...
        $listingViews->save();//please note to save it at lease, very important
    }
}
