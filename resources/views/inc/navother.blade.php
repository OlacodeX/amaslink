...
.sticky a.navbar-brand img{
    ...
    .sticky .nav.navbar-nav.navbar-right li a{
        font-weight: bold;
        font-size: 11px;
        line-height: 1.5em;
        color: #b2000093;
    ...
    .sticky .nav.navbar-nav.navbar-right li a.btn.btn-info{
        font-weight: 600;
        font-size: 12px;
        line-height: 1.5em;
        color: #b2000093;
...
.sticky a.navbar-brand img{
  ...
  .container-fluid.top .dropdown-menu .dropdown-item{
        font-weight: bold;
        color: #f1f1f1;
        font-size: 12px;
    }
...
<div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="myNavbar" style="border: none;">
        <ul class="nav navbar-nav navbar-right" style="border: none;">
          ...
          <li><a href="./alluctions">Auctions</a></li>
