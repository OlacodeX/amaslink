...
<div class="w3-container">
    <p>
        <a href="./adminall" class="btn btn-info btn-sm">All</a>
        <a href="./adminpending" class="btn btn-info btn-sm">Pending</a>
        <a href="./adminapproved" class="btn btn-info btn-sm">Approved</a>
        <a href="./adminauctions" class="btn btn-info btn-sm">Auctions</a>
    </p>
 @include('inc.messages')
<h3 class="text-justify title">Items On <span>Auction</span></h3>
<div class="top">
<p><i class="fa fa-info-circle"></i> Before marking your item as sold out, be sure the item is no longer available for sale as this action automatically delist your
...
<table class="table table-stripped table-condensed table-responsive">
   ...
   @if ($listing->type == 'paid/auction')
    ...
    <td>
        ...
        {!!Form::open(['action' => 'ListingsController@delist', 'method' => 'POST', 'style' => 'margin-right:20px;'])!!}
    ...
    <td>
        ...
        {!!Form::open(['action' => 'HomeController@show', 'method' => 'GET', 'style' => 'margin-right:20px;'])!!}
        
        {{Form::hidden('id', $listing->id)}}
        {{Form::submit('See Bids', ['class' => 'btn btn-danger btn-sm'])}}
        {!!Form::close()!!}
        
    </td>
    <td>
            {!!Form::open(['action' => ['ListingsController@destroy', $listing->id], 'method' => 'POST', 'style' => 'margin-right:20px;'])!!}
