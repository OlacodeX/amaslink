...
<div class="container edit">
    <h3 class="title">Edit <span>Post</span></h3>
    @include('inc.messages')
   {!! Form::open(['action' => ['PostsController@update', $post->slug]/**the id tells it the post to update*/, 'method' => 'POST',  'enctype' => 'multipart/form-data']) /** The action should be the block of code in the store function in PostsController
   **/ !!}
    ...
    {{Form::submit('Update Post', ['class' => 'btn btn-success btn-md pull-left', 'style' => 'text-transform:uppercase;'])}}
   {!! Form::close() !!}
</div>
