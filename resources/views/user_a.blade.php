...
@if (count($listings) > 0)
<table class="table table-stripped table-condensed table-responsive" style="width: 85%">
    <tr>
        <th>Title</th>
        <th>Images</th>
        <th>Status</th>
   ...
   @if ($listing->type == 'paid')
    ...
    <td>
        ...
        {!!Form::open(['action' => 'ListingsController@boost', 'method' => 'POST'])!!}
        {{Form::hidden('amount', '3.00')}}
