                ...
                <div class="card-body">
                    <div class="col-sm-3">
                        ...
                        <p class="pull-right">
                            ...
                            <span>{{App\Models\Listings::count() }} </span> <br>
                            Total Submitted Listings
                        </p>
                    </div>
                    <div class="col-sm-3">
                        ...
                        <p class="pull-right">
                           ...
                           <span> {{App\Models\Listings::where('status', 'pending')->count()}} </span><br>
                    ...
                    <div class="col-sm-3">
                        ...
                        <p class="pull-right">
                            ...
                            <span>{{App\Models\Listings::where('status', 'approved')->count()}} </span><br>
                            Active Listings
                        </p>
                    </div>
                    <div class="col-sm-3">
                        ...
                        <p class="pull-right">
                            ...
                            <span> {{App\Models\Posts::where('user_id', auth()->user()->id)->count()}}</span><br>
                            Blog Posts
                        </p>
                </div>
            </div>
