...
@endsection
@include('inc.css.category_result')
@section('content')
    <div class="row main">
        @include('inc.nav')
    </div>
<div class="row ads">
    <div class="container text-justify">
        @php
            $cat = $_GET['category'];
        @endphp
        <h2 class="title text-center" style="text-transform: uppercase;">{{$cat}} LISTINGS</h2>
    ...
    <div class="text-center">
        ...
        @else
        <p class="text-center">No listings in this category yet. <br> <a class="btn btn-success" href="{{ URL::previous() }}">Go back</a></p>
        @endif
    </div>
</div>
<div class="row">
