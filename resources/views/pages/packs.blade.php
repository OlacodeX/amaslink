        ...
        <div class="col-sm-4 text-center">
            <div class="panel-default text-center">
                <div class="panel-body">
                    ...
                    <hr class="hrr">
                    <p class="text-center">
                        {!! Form::open(['action' => 'PaymentController@charge', 'method' => 'POST']) /** The action should be the block of code in the store function in PostsController
                        **/ !!}
