                ...
                <div class="card-body">
                    ...
                    <div class="container">
                        <div class="col-sm-3">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <h5 class="card-title">Hot Line</h5>
                                        <p class="card-text"><a href="tel:{{$user->phone}}"><i class="fa fa-phone"></i>{{$user->phone}}</a></p>
                    ...
                    <hr>
                       ...
                       <div class="col-sm-12">
                        ...
                        <div class="col-sm-12">
                                ...
                                <div class="col-sm-6">
                                    <li><i class="fa fa-angle-double-left first"></i><span><a href="mailto:{{$user->email}}">{{$user->email}}</a></span></li>
