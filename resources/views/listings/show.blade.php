            ...
            <div class="col-sm-8 bb text-justify">
                <div class="col-sm-8">
                  <h3 class="text-justify">{{$listing->title}}</h3>
                    ...
                    <i class="fa fa-angle-double-right"></i><small class="text-justify">{{$listing->category}}</small><br>
                    @if ($listing->subcategory !== 'N/A' && !empty($listing->price)) 
                   ...
                   <br> <i class="fa fa-angle-double-right"></i><small class="text-justify">{{$listing->land_area}} sqm</small>
                    @endif <br>
          ...
          <div class="chat-popup" id="myForm">
            ...
            **/ !!}<br>
              ...
              {!! Form::close() !!}
                    ...
                    @if ($listing->phone !== '123')
                    <br> <small class="text-justify"><i class="fa fa-phone-square"></i><br>{{$listing->phone}}</small>
                    @endif
                    @endif
